...
{GREEN}
{'-'*50}
{"THIS IS POWERFUL DDOS TOOL BY TOXIC_GANG":^50}
{"RUN ONLY IN CLOUD SHELL, DON'T RUN ON TERMUX":^50}
{"Coder: Toxic_Gang"}
...
if __name__ == "__main__":
    ...
    print("Join Our Telegram Channel for more")
    print(" We are Toxic")
